    ...
    f.extend(b, {
        ...
        open: function(a, d) {
            if (a && (f.isPlainObject(d) || (d = {}), !1 !== b.close(!0))) return f.isArray(a) || (a = t(a) ? f(a).get() : [a]), f.each(a, function(e, c) {
                ...
                j || ("inline" === m ? g ? j = f(q(g) ? g.replace(/.*(?=#[^\s]+jQuery)/, "") : g) : k.isDom && (j = c) : "html" === m ? j = g : !m && (!g &&
        ...
        isImage: function(a) {
            return q(a) && a.match(/(^data:image\/.*,)|(\.(jp(e|g|eg)|gif|png|bmp|webp|svg)((\?|#).*)?jQuery)/i)
        },
        isSWF: function(a) {
            return q(a) && a.match(/\.(swf)((\?|#).*)?jQuery/i)
        },
        _start: function(a) {
            var d = {},
                e, c;
...
Themecfg = {
    ...
    "newsletter": {
        ...
        "background_image": "stores\/5\/pupup_wat.jpg"
    },
    "categorysearch": {
        "enabled": "0",
        "select_category_on_category_pages": "0",
        "show_subcategories": "1",
        "subcategories_level": "2",
        "indentation_text": "-"
    },
    "checkout": {
        "crosssellsSlide": "1"
...
jQuery(document).ready(function(jQuery) {
    ...
    (function(selector) {
        ...
        if (!popupCookie || popupCookie == 'undefined') {
            var jQuerycontent = jQuery(selector);
            ...
            var imageUrl = "#" + image;
            var popup = jQuery('#popup-newsletter', jQuerycontent);
            var pwidth = Themecfg.newsletter.width;
            var pheight = Themecfg.newsletter.height;
            pwidth = typeof pwidth !== 'undefined' ? pwidth : 700;
            ...
            if (Themecfg.newsletter.autoClose > 0) setTimeout(function() {
                jQuery.fancybox.close()
            }, timeClose);
            jQuery('.subscribe-bottom input', popup).on('click', function() {
            ...
            if (messages) {
                var jQuerymessages = jQuery('.messages').attr('id', 'popupNewsletterMessages').wrap("<div></div>");
                jQuerymessages.fancybox({
                    padding: '0px',
                    transitionIn: 'fade',
                    transitionOut: 'fade',
                    // showCloseButton: false,
